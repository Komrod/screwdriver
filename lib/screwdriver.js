...
/**
 * Sync mkdirp, create directory and parents directory if needed, similar to command mkdir -p
 * @method mkdirpSync
...
/**
 * Create directory and parents directory if needed, similar to command mkdir -p
 * @method mkdirp
 * @param  {string}   dir      Directory to create
 * @param  {string}   mode     Creation mode, default '0777'
...
/**
 * Sort array unsing quicksort algorythm
 * @method quickSort
 * @param {array} array
...
if (window.performance && window.performance.now) {
    screwdriver.prototype.getTime = function() {
